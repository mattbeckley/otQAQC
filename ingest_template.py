...
config2['recursive'] = 0
config2['getFilesDir'] =  '/mnt/data1/OTProcessing/Shortname/LAS'
...
config2['winePath'] = '/opt/wine-stable/bin/wine /opt/LASTools/bin'
...
config3['getFilesDir']  = '/mnt/data1/OTProcessing/Shortname/LAS'
config3['ftype']        = 'f'
config3['recursive']    = 0
config3['fsuffix']      = '_EPSG6339'
config3['overwrite']    = 0
config3['LAZDir_out']   = '/mnt/data1/OTProcessing/Shortname/forbetaupload/LAZ'
...
config4['getFilesDir'] =  '/mnt/data1/OTProcessing/Shortname/rasters'
...
config5['getFilesDir'] =  '/mnt/data1/OTProcessing/Shortname/rasters'
...
config6['getFilesDir'] =  '/mnt/data1/OTProcessing/Shortname/rasters'
...
config7['getFilesDir'] =  '/mnt/data1/OTProcessing/Shortname/rasters'
...
config8['getFilesDir'] =  '/mnt/data1/OTProcessing/Shortname/LAZ'
...
config9['getFilesDir'] =  '/mnt/data1/OTProcessing/Shortname/DSM'

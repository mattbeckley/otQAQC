...
- *CreateLAZIndex*.  This module will take in a list of files, and
  create a tile boundary of the bounding box of the laz files.  This
  ...
  contain the lidar file name of each of the bounding boxes.

- *LAZTileFile*.  Name of the shapefile that is output from
   CreateLAZIndex.  This shapefile will show the bounding boxes of all
   the lidar files.  A zipped version of this shapefile should be
   placed in the cloud to help users download specific files from
   bulk.  